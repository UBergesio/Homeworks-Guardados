...
function crearGato(nombre, edad) {
   ...
   Mascota.meow = function () {return ('Meow!')}
   return Mascota
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var newObjet = {nombre: nombre, email: email, password: password}
   return newObjet
}
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   var tieneElValor = objetoUsuario['email']
   if (tieneElValor != null){
      return true
   } else if (tieneElValor == null){
   return false}
}
...
function verificarPassword(objetoUsuario, password) {
   ...
   return true}
   else if (objetoUsuario['password'] != password){
      return false
   }
}
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
  var suma = 0
  var propiedad = objetoUsuario['posts'] 
  for (let i = 0; i < propiedad.length; i++){
   suma = propiedad[i]['likes'] + suma
  }
  return suma
}
